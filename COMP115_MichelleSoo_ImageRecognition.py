...
class DrawingClassifier:
    ...
    def classes_prompt(self):
        ...
        if os.path.exists(self.proj_name):
            ...
            self.class1 = simpledialog.askstring("Class 1", "What is the first shape called?", parent=msg)
            self.class2 = simpledialog.askstring("Class 2", "What is the second shape called?", parent=msg)
            self.class3 = simpledialog.askstring("Class 3", "What is the third shape called?", parent=msg)
    ...
    def init_gui(self):
        ...
        self.root = Tk()
        self.root.title(f"Michelle's Drawing Classifier - {self.proj_name}")
        #create a canvas
        self.canvas = Canvas(self.root, width=WIDTH-10, height=HEIGHT-10, bg="white")
        self.canvas.pack(expand=YES, fill=BOTH)
        #bind with moving the mouse, left button click
        #this is what makes the left button to paint
        ...
        #clear button to clear the brush
    ...
    #draw a blank rectangle above all to clear
    #clear the canvas
    def clear(self):
        ...
        #we add to image list
        #add class labels
        #a label is a tag or identifying element that explains what the piece of data is
    ...
    def train_model(self):
        ...
        tkinter.messagebox.showinfo("Michelle's Drawing Classifier", "Model successfully trained!", parent=self.root)
    ...
    def predict(self):
        ...
        if prediction[0] == 1:
            tkinter.messagebox.showinfo("Michelle's Drawing Classifier", f"The drawing is probably a {self.class1}", parent=self.root)
        elif prediction[0] == 2:
            tkinter.messagebox.showinfo("Michelle's Drawing Classifier", f"The drawing is probably a {self.class2}", parent=self.root)
        elif prediction[0] == 3:
            tkinter.messagebox.showinfo("Michelle's Drawing Classifier", f"The drawing is probably a {self.class3}", parent=self.root)
    ...
    def save_model(self):
        ...
        tkinter.messagebox.showinfo("Michelle's Drawing Classifier", "Model successfully saved!", parent=self.root)

    def load_model(self):
        file_path = filedialog.askopenfilename()
        with open(file_path, "rb") as f:
            self.clf = pickle.load(f)
        tkinter.messagebox.showinfo("Michelle's Drawing Classifier", "Model successfully loaded!", parent=self.root)
    ...
    def save_everything(self):
        ...
        with open(f"{self.proj_name}/{self.proj_name}_data.pickle", "wb") as f:
            pickle.dump(data, f)
        tkinter.messagebox.showinfo("Michelle's Drawing Classifier", "Project successfully saved!", parent=self.root)
